...
contextBridge.exposeInMainWorld('launcher', {
  ...
  instances: {
    ...
    pickImportFile: () => ipcRenderer.invoke('instances:pickImportFile'),
    import: (zipPath: string, customName: string) => ipcRenderer.invoke('instances:import', zipPath, customName),
